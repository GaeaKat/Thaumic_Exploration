...
public class ThaumicExploration {
  ...
  @SidedProxy(clientSide = "flaxbeard.thaumicexploration.client.ClientProxy",
  ...
  public void preInit(FMLPreInitializationEvent event) {
    ...
    GameRegistry.registerBlock(floatCandle, BlockCandleItem.class,
                               "floatCandle");
    ...
    blankSeal = (new ItemBlankSeal().setCreativeTab(tab).setTextureName(
        "thaumicexploration:sealBlank"));
    ...
    // maskEvil = new ItemTXArmorSpecialDiscount(maskEvilID,
    // ThaumcraftApi.armorMatSpecial, 2,
    ...
    taintBerry =
        new ItemTaintSeedFood(1, 0.3F, Blocks.tnt, ConfigBlocks.blockTaint)
            .setCreativeTab(tab)
  ...
  public void load(FMLInitializationEvent event) {
    ...
    // fakeAspectNecro = new FauxAspect("Necromantic Energy", 0x870404, null,
    // new ResourceLocation("thaumicexploration",
    // "textures/tabs/necroAspect.png"), 771);
    ...
    // Tiles
    GameRegistry.registerTileEntity(TileEntityFloatyCandle.class,
                                    "tileEntityFloatyCandle");
    GameRegistry.registerTileEntity(TileEntityAutoSorter.class,
                                    "tileEntityAutoSorter");
    GameRegistry.registerTileEntity(TileEntityBoundChest.class,
                                    "tileEntityBoundChest");
    GameRegistry.registerTileEntity(TileEntityBoundJar.class,
                                    "tileEntityBoundJar");
    GameRegistry.registerTileEntity(TileEntityThinkTank.class,
                                    "tileEntityThinkTank");
    GameRegistry.registerTileEntity(TileEntityEverfullUrn.class,
                                    "tileEntityEverfullUrn");
    GameRegistry.registerTileEntity(TileEntityEverburnUrn.class,
                                    "tileEntityEverburnUrn");
    GameRegistry.registerTileEntity(TileEntitySoulBrazier.class,
                                    "tileEntitySoulBrazier");
    GameRegistry.registerTileEntity(TileEntityCrucibleSouls.class,
                                    "tileEntityCrucibleSouls");
    GameRegistry.registerTileEntity(TileEntityReplicator.class,
                                    "tileEntityReplicator");
    GameRegistry.registerTileEntity(TileEntityTrashJar.class,
                                    "tileEntityTrashJar");
    // GameRegistry.registerTileEntity(TileEntityNecroPedestal.class,
    // "tileEntityNecroPedestal");
    // GameRegistry.registerTileEntity(TileEntityNecroFire.class,
    // "tileEntityNecroFire"); Blocks

    // Wands
    STAFF_ROD_AMBER = new StaffRod(
        "AMBER", 25, new ItemStack(ThaumicExploration.amberStaffCore), 18,
        new WandRodAmberOnUpdate(),
        new ResourceLocation(
            "thaumicexploration:textures/models/rodAmber.png"));
    WAND_ROD_AMBER =
        new WandRod("AMBER", 10, new ItemStack(ThaumicExploration.amberCore), 8,
                    new WandRodAmberOnUpdate(),
                    new ResourceLocation(
                        "thaumicexploration:textures/models/rodAmber.png"));
    WAND_ROD_CRYSTAL = new WandRodTransmutative(
        "TRANSMUTATION", 75,
        new ItemStack(ThaumicExploration.transmutationCore), 6,
    ...
    STAFF_ROD_CRYSTAL = new StaffRodTransmutative(
        "TRANSMUTATION", 175,
        new ItemStack(ThaumicExploration.transmutationStaffCore), 14,
        new WandRodTransmutationOnUpdate(),
        new ResourceLocation("thaumicexploration:textures/models/0.png"));
    STAFF_ROD_NECRO = new StaffRod(
        "NECROMANCER", 200, new ItemStack(ThaumicExploration.necroStaffCore),
        15, new WandRodNecromancerOnUpdate(),
        new ResourceLocation(
            "thaumicexploration:textures/models/rodNecro.png"));
    // STAFF_ROD_NECRO.setRunes(true);
    if (ConfigTX.breadWand) {
      WAND_ROD_BREAD =
          new WandRod("BREAD", 39, new ItemStack(ThaumicExploration.breadCore),
                      8, new WandRodBreadOnUpdate(),
                      new ResourceLocation(
                          "thaumicexploration:textures/models/rodBread.png"));
    }
    WAND_CAP_SOJOURNER = new WandCap(
        "SOJOURNER", 0.95F, new ItemStack(ThaumicExploration.sojournerCap), 6);
    WAND_CAP_SOJOURNER.setTexture(new ResourceLocation(
        "thaumicexploration:textures/models/capSojourner.png"));

    WAND_CAP_MECHANIST = new WandCap(
        "MECHANIST", 0.95F, new ItemStack(ThaumicExploration.mechanistCap), 6);
    WAND_CAP_MECHANIST.setTexture(new ResourceLocation(
        "thaumicexploration:textures/models/capMechanist.png"));

    // WandRod.rods.put("transmutation1", WAND_ROD_CRYSTAL1);

    if (ConfigTX.enchantmentBindingEnable) {
      enchantmentBinding =
          new EnchantmentBinding(ConfigTX.enchantmentBindingID, 1);
    }
    if (ConfigTX.enchantmentNVEnable) {
      enchantmentNightVision =
          new EnchantmentNightVision(ConfigTX.enchantmentNightVisionID, 1);
    }
    if (ConfigTX.enchantmentDisarmEnable) {
      enchantmentDisarm =
          new EnchantmentDisarm(ConfigTX.enchantmentDisarmID, 1);
    }
    ...
    EntityRegistry.registerModEntity(EntityTaintacleMinion.class,
                                     "TaintacleMinion", 0,
                                     ThaumicExploration.instance, 64, 3, false);
    //		enhancedHelmetRunic = new ItemEnhancedRunicArmor(1,
    //enhancedHelmetRunicID, ThaumcraftApi.armorMatSpecial, 0,
    //0).setUnlocalizedName("thaumicexploration:enhancedHelmetRunic").setCreativeTab(tab);
    //		enhancedChestRunic = new
    //ItemEnhancedRunicArmor(1,enhancedChestRunicID,
    //ThaumcraftApi.armorMatSpecial, 0,
    //1).setUnlocalizedName("thaumicexploration:enhancedChestplateRunic").setCreativeTab(tab);
    //		enhancedLegsRunic = new ItemEnhancedRunicArmor(1,enhancedLegsRunicID,
    //ThaumcraftApi.armorMatSpecial, 0,
    //2).setUnlocalizedName("thaumicexploration:enhancedLeggingsRunic").setCreativeTab(tab);
    //		enhancedBootsRunic = new
    //ItemEnhancedRunicArmor(1,enhancedBootsRunicID,
    //ThaumcraftApi.armorMatSpecial, 0,
    //3).setUnlocalizedName("thaumicexploration:enhancedBootsRunic").setCreativeTab(tab);
    //		enhancedHelmetRunic2 = new ItemEnhancedRunicArmor(2,
    //enhancedHelmetRunic2ID, ThaumcraftApi.armorMatSpecial, 0,
    //0).setUnlocalizedName("thaumicexploration:enhancedHelmetRunic");
    //		enhancedChestRunic2 = new
    //ItemEnhancedRunicArmor(2,enhancedChestRunic2ID,
    //ThaumcraftApi.armorMatSpecial, 0,
    //1).setUnlocalizedName("thaumicexploration:enhancedChestplateRunic");
    //		enhancedLegsRunic2 = new
    //ItemEnhancedRunicArmor(2,enhancedLegsRunic2ID,
    //ThaumcraftApi.armorMatSpecial, 0,
    //2).setUnlocalizedName("thaumicexploration:enhancedLeggingsRunic");
    //		enhancedBootsRunic2 = new
    //ItemEnhancedRunicArmor(2,enhancedBootsRunic2ID,
    //ThaumcraftApi.armorMatSpecial, 0,
    ...
    potionTaintWithdrawl =
        (new TXTaintPotion(ConfigTX.potionTaintWithdrawlID, true, 0))
      ...
      if (ore != null) {
        if (ore.equals("logWood")) {
          for (ItemStack is : OreDictionary.getOres(ore)) {
            ...
            if (!(is.getItem() ==
                  Item.getItemFromBlock(ConfigBlocks.blockMagicalLog)) &&
                ot.getAspects().length > 0)
              allowedItems.add(
                  MutablePair.of(is.getItem(), is.getItemDamage()));
          }
        }
        ...
        if (ConfigTX.allowModWoodReplication) {
          if (ConfigTX.allowMagicPlankReplication) {
            ...
            if (ore.equals("plankWood")) {
              for (ItemStack is : OreDictionary.getOres(ore)) {
                ...
                ot = ThaumcraftCraftingManager.getBonusTags(is, ot);
                if (!(is.getItem() ==
                      Item.getItemFromBlock(ConfigBlocks.blockWoodenDevice)) &&
                    ot.getAspects().length > 0)
                  allowedItems.add(
                      MutablePair.of(is.getItem(), is.getItemDamage()));
              }
          ...
          allowedItems.add(
              MutablePair.of(Item.getItemFromBlock(Blocks.wooden_slab),
                             OreDictionary.WILDCARD_VALUE));
          allowedItems.add(
              MutablePair.of(Item.getItemFromBlock(Blocks.birch_stairs),
                             OreDictionary.WILDCARD_VALUE));
          allowedItems.add(
              MutablePair.of(Item.getItemFromBlock(Blocks.oak_stairs),
                             OreDictionary.WILDCARD_VALUE));
          allowedItems.add(
              MutablePair.of(Item.getItemFromBlock(Blocks.jungle_stairs),
                             OreDictionary.WILDCARD_VALUE));
          allowedItems.add(
              MutablePair.of(Item.getItemFromBlock(Blocks.spruce_stairs),
                             OreDictionary.WILDCARD_VALUE));
          allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.log),
                                          OreDictionary.WILDCARD_VALUE));
          allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.log2),
                                          OreDictionary.WILDCARD_VALUE));
          allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.planks),
                                          OreDictionary.WILDCARD_VALUE));
          if (ConfigTX.allowMagicPlankReplication) {
            allowedItems.add(MutablePair.of(
                Item.getItemFromBlock(ConfigBlocks.blockWoodenDevice), 6));
            allowedItems.add(MutablePair.of(
                Item.getItemFromBlock(ConfigBlocks.blockWoodenDevice), 7));
          }
        }
        if (ConfigTX.allowModStoneReplication) {
          ...
          allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.stone),
                                          OreDictionary.WILDCARD_VALUE));
          allowedItems.add(
              MutablePair.of(Item.getItemFromBlock(Blocks.cobblestone),
                             OreDictionary.WILDCARD_VALUE));
        }
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.mossy_cobblestone),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_slab), 0));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_slab), 3));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_stairs),
                           OreDictionary.WILDCARD_VALUE));

        // All sandstone, stairs, slab
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.sand),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.sandstone),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.sandstone_stairs),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_slab), 1));

        // All stone bricks, stairs, slab
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.brick_block),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.brick_stairs),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_slab), 5));

        // Bricks, stairs, slab
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stonebrick),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_brick_stairs),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_slab), 4));
        ...
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.nether_brick),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.nether_brick_stairs),
                           OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.stone_slab), 6));

        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.soul_sand),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.gravel),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.glass),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.grass),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.dirt),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.snow),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(MutablePair.of(Item.getItemFromBlock(Blocks.clay),
                                        OreDictionary.WILDCARD_VALUE));
        allowedItems.add(
            MutablePair.of(Item.getItemFromBlock(Blocks.hardened_clay),
                           OreDictionary.WILDCARD_VALUE));
      }
    }
  }
  ...
  public void registerEntity(Class<? extends Entity> entityClass,
                             String entityName, int bkEggColor,
                             int fgEggColor) {
    int id = EntityRegistry.findGlobalUniqueEntityId();

    EntityRegistry.registerGlobalEntityID(entityClass, entityName, id);
    EntityList.entityEggs.put(Integer.valueOf(id),
                              new EntityEggInfo(id, bkEggColor, fgEggColor));
  }

  public void addSpawn(Class<? extends EntityLiving> entityClass, int spawnProb,
                       int min, int max, BiomeGenBase[] biomes) {
    if (spawnProb > 0) {
  ...
  private class TXTab extends CreativeTabs {
    ...
    public TXTab(int par1, String par2Str) { super(par1, par2Str); }
