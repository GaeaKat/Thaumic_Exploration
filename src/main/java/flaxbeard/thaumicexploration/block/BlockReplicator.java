...
public class BlockReplicator extends BlockContainer {
  ...
  public BlockReplicator() { super(Material.iron); }
  ...
  public boolean onBlockActivated(World world, int x, int y, int z,
                                  EntityPlayer player, int side, float par7,
      ...
      if (player.getCurrentEquippedItem() != null &&
          (ThaumicExploration.allowedItems.contains(MutablePair.of(
           ...
           ThaumicExploration.allowedItems.contains(
               MutablePair.of(player.getCurrentEquippedItem().getItem(),
  ...
  public int getRenderType() { return ThaumicExploration.replicatorRenderID; }
