...
public class BlockCrucibleSouls extends BlockContainer {
  ...
  @Override
  public IIcon getIcon(IBlockAccess iblockaccess, int i, int j, int k,
                       int side) {
    TileEntityCrucibleSouls te =
        (TileEntityCrucibleSouls)iblockaccess.getTileEntity(i, j, k);
  ...
  //        this.middleSide =
  //        par1IIconRegister.registerIIcon("thaumicExploration:everfullUrnMS");
  //        this.topSide =
  //        par1IIconRegister.registerIIcon("thaumicExploration:everfullUrnTS");
  //        this.topTop =
  //        par1IIconRegister.registerIIcon("thaumicExploration:everfullUrnTT");
  //        this.bottomTop =
  //        par1IIconRegister.registerIIcon("thaumicExploration:everfullUrnBT");
  //        this.bottomBottom =
  //        par1IIconRegister.registerIIcon("thaumicExploration:everfullUrnBB");
  //        this.topBottom =
  //        par1IIconRegister.registerIIcon("thaumicExploration:everfullUrnTB");
  //    }
}
