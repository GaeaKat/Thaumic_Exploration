...
public class BlockFloatyCandle
    extends BlockCandle implements ITileEntityProvider, IInfusionStabiliser {
  ...
  //		this.iconStub =
  //ir.registerIcon("thaumicexploration:blankTexture");
  //	}
  //

  public int getRenderType() { return ThaumicExploration.floatCandleRenderID; }
  ...
  public void randomDisplayTick(World par1World, int par2, int par3, int par4,
    ...
    par1World.spawnParticle("smoke", var7, var9 + move, var11, 0.0D, 0.0D,
                            0.0D);
    par1World.spawnParticle("flame", var7, var9 + move, var11, 0.0D, 0.0D,
                            0.0D);
  }
