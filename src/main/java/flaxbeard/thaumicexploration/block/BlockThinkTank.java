...
public class BlockThinkTank extends BlockContainer {
  ...
  @SideOnly(Side.CLIENT) private Icon furnaceIconTop;
  @SideOnly(Side.CLIENT) private Icon furnaceIconFront;
  ...
  public boolean onBlockActivated(World par1World, int par2, int par3, int par4,
    ...
    if (par1World.isRemote) {
      ...
      if (tileentityfurnace != null) {
        par5EntityPlayer.openGui(ThaumicExploration.instance, 0, par1World,
                                 par2, par3, par4);
      }
        ...
        for (int j1 = 0; j1 < tileentityfurnace.getSizeInventory(); ++j1) {
          ...
          if (itemstack != null) {
            ...
            while (itemstack.stackSize > 0) {
              ...
              float f3 = 0.05F;
              entityitem.motionX =
                  (double)((float)this.furnaceRand.nextGaussian() * f3);
              entityitem.motionY =
                  (double)((float)this.furnaceRand.nextGaussian() * f3 + 0.2F);
              entityitem.motionZ =
                  (double)((float)this.furnaceRand.nextGaussian() * f3);
