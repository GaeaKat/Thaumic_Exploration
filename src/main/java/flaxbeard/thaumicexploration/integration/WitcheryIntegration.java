...
public class WitcheryIntegration {
  ...
  public static void fillWaterCauldron(TileEntity tile, World world) {
    ...
    cauldronBlock.tryFillWith(world, cauldron.xCoord, cauldron.yCoord,
                              cauldron.zCoord,
                              new FluidStack(FluidRegistry.WATER, 1000));
    cauldron.getWorldObj().func_147453_f(cauldron.xCoord, cauldron.yCoord,
                                         cauldron.zCoord,
                                         cauldron.getBlockType());
  }
  ...
  public static void fillWaterKettle(TileEntity tile, World world) {
    ...
    kettleBlock.tryFillWith(world, kettle.xCoord, kettle.yCoord, kettle.zCoord,
                            new FluidStack(FluidRegistry.WATER, 1000));
    kettle.getWorldObj().func_147453_f(kettle.xCoord, kettle.yCoord,
                                       kettle.zCoord, kettle.getBlockType());
  }
}
