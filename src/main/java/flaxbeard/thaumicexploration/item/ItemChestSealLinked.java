...
public class ItemChestSealLinked extends Item {
  ...
  public static final String[] itemNames = {
      "Pale",  "Orange", "Magenta",    "Light Blue", "Yellow", "Lime",
      "Pink",  "Gray",   "Light Gray", "Cyan",       "Purple", "Blue",
      "Brown", "Green",  "Red",        "Dark"};
  ...
  //        		stack = new ItemStack(this.itemID, 1,
  //        stack.getItemDamage()); 		return true;
  //
  //        	}
  //        	else
  //        	{
  ...
  public int getColorFromItemStack(ItemStack par1ItemStack, int par2) {
    if (par1ItemStack.getItemDamage() <= 15) {
      if (par2 == 0) {
        ...
        Color c = new Color(EntitySheep.fleeceColorTable[j][0],
  ...
  public boolean onItemUseFirst(ItemStack stack, EntityPlayer player,
    ...
    if (!player.canPlayerEdit(x, y, z, side, stack)) {
      ...
      if (var11 == Blocks.chest) {
        stack = new ItemStack(ThaumicExploration.chestSealLinked, 1,
                              stack.getItemDamage());
        return true;
  ...
  public String getUnlocalizedName(ItemStack item) {
    if (item.getItemDamage() <= 15) {
      return this.getUnlocalizedName() + ":" +
          itemNames[15 - item.getItemDamage()];
    }
    return "";
  }
  ...
  public void addInformation(ItemStack par1ItemStack,
    ...
    if (par1ItemStack.hasTagCompound()) {
      String dimension =
          "dimension " + par1ItemStack.stackTagCompound.getInteger("dim");
      ...
      par3List.add("Linked to " +
                   ...
                   par1ItemStack.stackTagCompound.getInteger("z") + " in the " +
                   dimension + " (Network " +
